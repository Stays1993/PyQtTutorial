# Form implementation generated from reading ui file '04_06_Login_Demo.ui'
#
...
class Ui_Form(object):
    ...
    def login(self):
        try:
            ...
            if result is None:
                self.label_result.setText(f"用户名或密码错误！")

            else:
                self.label_result.setText(f"登录成功！")
                my_dialog: QDialog = QDialog()
                my_dialog.setModal(True)
                my_dialog.exec()

        except pymysql.Error as error:
            self.label_result.setText(f"登录失败！\n{error}")
