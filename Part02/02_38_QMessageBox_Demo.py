# Form implementation generated from reading ui file '02_38_QMessageBox_Demo.ui'
#
...
class Ui_Dialog(QDialog):
    def setupUi(self, Dialog):
        ...
        self.pushButton_warn = QtWidgets.QPushButton(parent=Dialog)
        self.pushButton_warn.setObjectName("pushButton_warn")
        self.horizontalLayout.addWidget(self.pushButton_warn)
        self.pushButton_info = QtWidgets.QPushButton(parent=Dialog)
        self.pushButton_info.setObjectName("pushButton_info")
        self.horizontalLayout.addWidget(self.pushButton_info)
        self.pushButton_about = QtWidgets.QPushButton(parent=Dialog)
    ...
    def warn_msg(self):
        QMessageBox.warning(self, "Warning", "这是一条警告信息")

    def info_msg(self):
        QMessageBox.information(self, "Info", "这是一条提示信息")

    def about_msg(self):
        QMessageBox.about(self, "About", "这是一条关于信息")
